...
$mailboxes = Get-ExoMailBox -Filter {UserPrincipalName -like "leila.salman@mlstbrieuc.fr" -and RecipientTypeDetails -eq 'UserMailbox' -and CustomAttribute15 -eq "22STB"} | Select-Object UserPrincipalName
