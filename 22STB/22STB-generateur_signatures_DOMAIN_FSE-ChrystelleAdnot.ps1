...
$mailboxes = Get-ExoMailBox -Filter {UserPrincipalName -like "chrystelle.adnot@mlstbrieuc.fr" -and RecipientTypeDetails -eq 'UserMailbox' -and CustomAttribute15 -eq "22STB"} | Select-Object UserPrincipalName

# Chemin vers le template HTML
$templateSignatureHTML = Get-Content -Path "C:\Users\ThierryLEDÛ\Downloads\Signature_de_mail\22STB-template-signature-FSE-projet-sante.html" -raw
