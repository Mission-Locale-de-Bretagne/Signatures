...
$users = Get-ExoMailBox -Filter {UserPrincipalName -like "*@mlceb.org" -and RecipientTypeDetails -eq 'UserMailbox' -and CustomAttribute15 -eq "56PLO"} | Select-Object firstname,lastname,title,phone,mobilephone,userprincipalname,streetaddress,postalcode,city,Office,Company
...
$templateSignatureHTML = Get-Content -Path "C:\Users\VincentMARIE\OneDrive - ARMLB\Documents\WindowsPowerShell\Scripts\Signatures\56PLO-template-signature.html" -raw
