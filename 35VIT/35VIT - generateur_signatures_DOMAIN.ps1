...
$users = Get-ExoMailBox -Filter {UserPrincipalName -like "*@missionlocale-portedebretagne.fr" -and RecipientTypeDetails -eq 'UserMailbox' -and CustomAttribute15 -eq "35VIT"} | Select-Object firstname,lastname,title,phone,mobilephone,userprincipalname,streetaddress,postalcode,city,Office,Company
