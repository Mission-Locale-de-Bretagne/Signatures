...
$mailboxes = Get-ExoMailBox -Filter {UserPrincipalName -like "*@mlauray.fr" -and RecipientTypeDetails -eq 'UserMailbox' -and CustomAttribute15 -eq "56AUR"} | Select-Object UserPrincipalName

# Chemin vers le template HTML
$templateSignatureHTML = Get-Content -Path "C:\Users\VincentMARIE\OneDrive - ARMLB\Documents\WindowsPowerShell\Scripts\Pack Signature HTML\Signatures\56AUR-template-signature.html" -raw
